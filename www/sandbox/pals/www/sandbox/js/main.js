...
var firebase = new Firebase("https://fiery-fire-1936.firebaseio.com/signatures");
var wtp = {
  getSignatures : function(){
    $.ajax({
      url:"https://api.whitehouse.gov/v1/petitions/53d81aea704301a147000001/signatures.jsonp",
      dataType: 'jsonp'
    }).done(function(data){
      wtp.displaySignatures(data),
      wtp.storeSignatures(data)
    });
  },
  displaySignatures : function(data){
    console.log(data)
  },
  storeSignatures : function(data){
    firebase.child("signatures").set(data);
  }
};
wtp.getSignatures();